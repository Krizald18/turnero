...
class Welcome extends Private_Controller {
	public function index() {
		...
		$data['descripcion'] = 'Página de expedición de turnos para el registro civil en la Unidad de Servicios Estatales Sinaloa';
	...
	public function login() {
		...
		$data['descripcion'] = 'Página de inicio de sesión para expedición de turnos, intruduzca un usuario y una contraseña válidos';
		$this->load->view('cabecera', $data);
